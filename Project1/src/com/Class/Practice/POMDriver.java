...
public class POMDriver {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		OhrmIntegDriver integDr=new OhrmIntegDriver("ff","http://opensource.demo.orangehrmlive.com");
		
				
		//LoginPageObjM loginPage=new LoginPageObjM(driver);
		
		integDr.loginPage.enterUname("admin");
		integDr.loginPage.enterPwd("admin");
		integDr.loginPage.submit();
		
		//WelcomPageObjM welPage= new WelcomPageObjM(driver);
